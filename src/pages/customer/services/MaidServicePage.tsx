...
import { Calendar as CalendarIcon, ChevronLeft, Clock, MapPin, UserCheck } from "lucide-react";
            ...
            <div className="space-y-1 text-sm">
              <p className="font-semibold text-foreground">
                {checkingAvailability
                  ...
                  : isOutOfRegion
                  ? 'Maid service is outside your region'
                  : hasResolvedLocation
                  ? 'Maid service can be booked in your region'
